...
from PedMove_gym.ped_pred.Interaction import getInteractionGridMask, getSequenceInteractionGridMask
from PedMove_gym.ped_pred.helper import *
...
class traj_prediction():
    ...
    def forward(self, x_seq, mask, x_seq_veh, mask_veh, ego_obs, ego_pre_planned_traj, timestamp):
        ...
        if self.saved_args.method == 3: # vanilla lstm
            ...
            # these variables are already of length "obs_length"
    ...
    def sample(self, x_seq, mask, args, net, saved_args,
        ...
        for tstep in range(args.obs_length-1, args.pred_length + args.obs_length-1):
            ...
            # ret_x_seq[tstep + 1, :, 5:9] = cov.reshape(cov.shape[0], cov.shape[1], 4).squeeze(0) # covariances of the trjecotries generated by the predictor
            ...
            if args.method == 4:
                ...
                ret_x_seq_convert = revert_postion_change(ret_x_seq_convert.cpu(), extended_mask,
                                                            first_values_dict, orig_x_seq, saved_args.obs_length, infer=True)#, use_cuda=args.use_cuda)
